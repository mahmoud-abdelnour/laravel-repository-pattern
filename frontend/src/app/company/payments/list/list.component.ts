...
export class ListComponent implements OnInit {
  ...
  apiFunc =  (opts = {}) => this.apiService.get(Endpoints.company.payments, opts);
  ...
  settings = {
    columns: {
      ...
      is_approved:{
        ...
        onComponentInitFunction: (instance) => instance.statusEnum = this.themeService.settings.COMPANY_SUBSCRIPTION_APPROVE.enum
      },
      actions: {
